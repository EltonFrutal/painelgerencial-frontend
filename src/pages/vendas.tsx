...
export default function Vendas() {
    ...
    <div className="flex justify-center items-center w-full h-full p-4">
        <div className="relative bg-white rounded-xl shadow p-4 w-full max-w-3xl h-[420px] border-none">
            {nivel !== "ano" && (
                <button
            ...
            <ResponsiveContainer width="100%" height="85%" className="!border-none">
